...
export const PreferencesStoreProvider = ({ children }: { children: React.ReactNode }) => {
  const [store] = useState<StoreApi<PreferencesState>>(() => createPreferencesStore(PREFERENCE_DEFAULTS));
